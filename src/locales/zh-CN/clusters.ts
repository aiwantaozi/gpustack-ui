export default {
  ...
  'clusters.topology.overview.acceleratorDomains': '加速器域 {count} 个',
  ...
  'clusters.topology.filter.unfilled': '只看未填的',
  'clusters.topology.columns': '列设置',
  'clusters.topology.columns.fields': '位置字段',
  'clusters.topology.columns.other': '其它',
  'clusters.topology.columns.custom': '自定义字段…',
  ...
  'clusters.topology.column.gpus': '卡 / 空闲',
  'clusters.topology.column.source': '来源',
  ...
  'clusters.topology.onboarding.withDomains':
    '已识别 {hosts} 台主机、{domains} 个加速器域（自动）。',
  ...
  'clusters.topology.onboarding.domains':
    '有 NVLink 多机互联或昇腾超节点的机器，加速器域会自动出现在这里。',
  ...
  'clusters.topology.mapping.layers': '层级',
  'clusters.topology.mapping.layers.tips': '一层套一层：下面的一定在上面里面',
  'clusters.topology.mapping.layers.status': '{count} 个字段在用',
  'clusters.topology.mapping.layers.status.empty': '未填任何字段',
  'clusters.topology.mapping.domain.status': '{count} 个域',
  'clusters.topology.mapping.domain.status.inactive': '未识别',
  ...
  'clusters.topology.mapping.domain.tips':
    '不分层的平行分组：按 NVLink / HCCS / UB 能否直接互访显存把机器圈在一起；一个域可以跨几个机柜，也可以小到只是一台机器',
  'clusters.topology.mapping.domain.stats':
    '共 {domains} 个域，最大的跨 {racks} 个机柜',
  'clusters.topology.mapping.subDomain.tips':
    '同域且同一级的机器优先放在一起（如 Atlas 950 的计算柜）；有域后可选一个位置字段作为域内的一级',
  'clusters.topology.mapping.subDomain.placeholder': '还没有机器报出加速器域',
  ...
  'clusters.topology.advanced.subDomain': '域内分级',
  'clusters.topology.advanced.subDomain.none': '无',
  'clusters.topology.advanced.subDomain.keys': '自填键…',
  ...
  'clusters.topology.custom.title': '自定义字段',
